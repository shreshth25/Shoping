...
<head>
        ...
        <!-- Bootstrap rtl -->
        <!--<link href="('admin/assets/bootstrap-rtl/bootstrap-rtl.min.css" rel="stylesheet" type="text/css"/>-->
        <!-- Pe-icon-7-stroke -->
        ...
        <!-- Theme style rtl -->
        <!--<link href="('admin/assets/dist/css/stylecrm-rtl.css" rel="stylesheet" type="text/css"/>-->
    </head>
    <body>
        <!-- Content Wrapper -->
